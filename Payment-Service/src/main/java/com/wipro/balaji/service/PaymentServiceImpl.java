...
import com.wipro.balaji.client.PaymentFeignClient;
...
import com.wipro.balaji.exceptions.PaymentNotFoundException;
...
public class PaymentServiceImpl implements PaymentService {
	...
	@Override
	public PaymentWithTransactionDto getPaymentDetailswithTransaction(Long id) {
		Payment payment = paymentRepository.findById(id)
                .orElseThrow(() -> new PaymentNotFoundException("Payment with Id " + id + " not found"));
		TransactionDto transactionDto = paymentFeignClient.getTransactionById(payment.getTransactionId()).getBody();
		
        PaymentWithTransactionDto response = new PaymentWithTransactionDto();
