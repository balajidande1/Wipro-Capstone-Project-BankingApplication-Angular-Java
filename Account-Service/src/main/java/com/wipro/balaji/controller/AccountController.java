...
import com.wipro.balaji.service.AccountService;
...
public class AccountController {
	...
	public Account patchAccount(@PathVariable Long id, @RequestBody Account account) {
		return accountService.patchAccountById(id, account);
	}
	
	@GetMapping("/accountWithCustomer/{id}")
	public AccountWithCustomerDto gettingAccountWithCustomerDetails(@PathVariable Long id) {
