...
import com.wipro.balaji.filter.JwtAuthenticationFilter;
...
public class GatewayConfig {
    ...
    public RouteLocator routes(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                // Customer route - requires ADMIN role
                .route("customer-service-route", r -> r.path("/api/customers/**")
                        ...
                        .uri("lb://CUSTOMER-SERVICEE"))
                
                // Account service route - requires either ADMIN or USER role
